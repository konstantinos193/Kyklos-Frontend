  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl sm:text-4xl font-semibold text-gray-900">Μαθηματικά</h1>
        ...
        <div className="mt-6 sm:mt-8 space-y-5 sm:space-y-6">
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-4 sm:p-5 shadow-sm">
            ...
            <ul className="mt-3 list-disc list-inside text-gray-700 space-y-1 text-sm sm:text-base">
              <li>Κατανόηση βασικών εννοιών</li>
              <li>Επίλυση σύνθετων προβλημάτων</li>
              <li>Εφαρμογές σε πραγματικά παραδείγματα</li>
            </ul>
          </section>
        </div>
      </div>
