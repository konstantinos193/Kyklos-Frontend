  ...
  return (
    <>
      ...
      {isOpen && (
        <div 
          id="mobile-menu"
          className="md:hidden fixed top-[calc(64px+32px)] sm:top-[calc(80px+32px)] left-0 right-0 bottom-0 bg-white shadow-lg border-t border-gray-200 z-40 overflow-y-auto"
        >
