  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-slate-200 via-slate-100 to-slate-200 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Floating particles */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-[#E7B109]/20 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mt-12">
          <a
            href="/blog"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-[#E7B109] to-[#D97706] hover:from-[#D97706] hover:to-[#B45309] text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Δείτε Όλα τα Άρθρα
