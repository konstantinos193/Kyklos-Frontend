...
const leadershipData: LeadershipMember = {
  ...
  bio: "Η placeholder_name1 είναι η ιδρύτρια και διευθύντρια του ΚΥΚΛΟΣ Φροντιστηρίου, με πάνω από 30 χρόνια εμπειρίας στον χώρο της εκπαίδευσης. Με πτυχίο Φιλολογίας από το Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης και μεταπτυχιακό στην Εκπαιδευτική Μεθοδολογία, έχει βοηθήσει εκατοντάδες μαθητές να πετύχουν τους στόχους τους.",
  achievements: [
