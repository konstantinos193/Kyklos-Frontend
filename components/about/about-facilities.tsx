...
const defaultContent = `Tα <b>ΦΡΟΝΤΙΣΤΗΡΙΑ ΚΡΟΝΟΣ</b> στεγάζονται σε ιδιόκτητες σύγχρονες εγκαταστάσεις στο κέντρο της Χαλκίδας.<br>Οι εγκαταστάσεις των <b>ΚΡΟΝΟΣ</b> είναι διαμορφωμένες κατάλληλα ώστε να ικανοποιούν στο απόλυτο τις αισθητικές απαιτήσεις και διδακτικές αναγκαιότητες μαθητών και καθηγητών.<br>Έχοντας δώσει μεγάλη βαρύτητα στην επικοινωνία με τους γονείς για την ολοκλήρωση του διδακτικού τους έργου έχουν διαμορφώσει κατάλληλους χώρους υποδοχής και γραμματειακής υποστήριξης.<br>Συγκεκριμένα οι εγκαταστάσεις αποτελούνται από:<br>Τα γραφεία της διεύθυνσης σπουδών και της γραμματείας διαμορφωμένα κατάλληλα για τις καθημερινές λειτουργικές ανάγκες ,για την υποδοχή και ενημέρωση των γονέων.
