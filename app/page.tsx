...
export const metadata: Metadata = generateSEOMetadata({
  title: "Φροντιστήρια Άρτα | ΚΥΚΛΟΣ Φροντιστήριο Γυμνάσιο Λύκειο ΕΠΑΛ",
  description:
    "ΚΥΚΛΟΣ Φροντιστήρια στην Άρτα. Κορυφαία φροντιστήρια για Γυμνάσιο, Λύκειο & ΕΠΑΛ με εξειδικευμένους καθηγητές και υψηλά ποσοστά επιτυχίας στις Πανελλαδικές εξετάσεις.",
  keywords: [
    "κυκλοσ φροντηστηριο",
    "φροντιστηρια αρτα",
    "φροντιστήρια άρτα", 
