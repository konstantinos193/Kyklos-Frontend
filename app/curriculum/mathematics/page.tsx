      ...
      <header className="border-b border-gray-200">
        <div className="px-4 sm:px-6 lg:px-8 py-10">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-gray-900">Μαθηματικά</h1>
            ...
            <p className="mt-4 text-sm sm:text-base text-gray-600 max-w-2xl">
              Άλγεβρα, Γεωμετρία, Ανάλυση — μεθοδική προετοιμασία και έμφαση στη λύση προβλημάτων.
            </p>
          </div>
        </div>
      </header>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 lg:p-7 shadow-sm">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="rounded-xl border border-blue-200 bg-blue-50 p-4">
                  <h3 className="font-semibold text-blue-900 mb-3">Άλγεβρα</h3>
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>• Εξισώσεις 1ου & 2ου βαθμού</li>
                    <li>• Συναρτήσεις & γραφικές παραστάσεις</li>
                    <li>• Ανισότητες & συστήματα</li>
                    <li>• Τριγωνομετρία</li>
                  </ul>
                </div>
                <div className="rounded-xl border border-green-200 bg-green-50 p-4">
                  <h3 className="font-semibold text-green-900 mb-3">Γεωμετρία</h3>
                  <ul className="text-sm text-green-800 space-y-1">
                    <li>• Επίπεδη γεωμετρία</li>
                    <li>• Στερεομετρία</li>
                    <li>• Αναλυτική γεωμετρία</li>
                    <li>• Θεωρήματα & αποδείξεις</li>
                  </ul>
                </div>
                <div className="rounded-xl border border-purple-200 bg-purple-50 p-4">
                  <h3 className="font-semibold text-purple-900 mb-3">Ανάλυση</h3>
                  <ul className="text-sm text-purple-800 space-y-1">
                    <li>• Όρια & συνέχεια</li>
                    <li>• Παράγωγοι & εφαρμογές</li>
                    <li>• Ολοκληρώματα</li>
                    <li>• Διαφορικές εξισώσεις</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 lg:p-7 shadow-sm">
              ...
              <ul className="mt-4 space-y-2 text-sm sm:text-base text-slate-700">
                <li className="flex gap-2"><span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#CF3B49]" />Στέρεη κατανόηση βασικών εννοιών</li>
                <li className="flex gap-2"><span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#CF3B49]" />Ικανότητα επίλυσης σύνθετων προβλημάτων</li>
                <li className="flex gap-2"><span className="mt-1 h-1.5 w-1.5 rounded-full bg-[#CF3B49]" />Εξοικείωση με εξεταστικές απαιτήσεις</li>
              </ul>
            </section>
          </div>
